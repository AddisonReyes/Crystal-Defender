...
func multiShoot():
	...
	var positions = [$magic/position1.global_position, $magic/position2.global_position, $magic/position3.global_position, $magic/position4.global_position]
	var directions = [$magic/direction1.global_position, $magic/direction2.global_position, $magic/direction3.global_position, $magic/direction4.global_position]
